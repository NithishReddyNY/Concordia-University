<?php
  ...
  while(!feof($myfile)) {
    ...
    array_push($images_array, $str_arr1);
  }
  fclose($myfile);
?>
<!DOCTYPE html>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><strong>Container All Images DataTable</strong></h3>
