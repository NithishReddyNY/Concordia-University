...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12">
      <div class="card card-outline card-primary collapsed-card <?php echo $color;?>">
        <div class="card-header">
          <h3 class="card-title"><?php echo $file_name[0]; ?></h3>
